${
    ...
    string PropDoc(Property property){
    string type = property.Type.IsGuid? "Guid" : property.Type.Name;
        return $"/** {property.DocComment?.Summary} [Type:{type}] */";
    }
   ...
   string TypeFormatted(Property property)
    ...
    string FormulateClassImports(Class currentClass)
    {
        ...
        {
            if (!prop.Attributes.Any(o=>o.Name == "JsonIgnore"))
    ...
    export interface $Name {$Properties(o=>!o.Attributes.Any(a=>a.Name == "JsonIgnore"))[
        $PropDoc
