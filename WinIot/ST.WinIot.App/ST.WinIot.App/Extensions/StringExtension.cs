...
namespace System
{
    public static class StringExtension
    {
        ...
        public static bool IsNullOfEmpty(this string valeur)
        {
        ...
        //    var Converted = await CompanyShop.Helper.CurrencyHelper.GetConvertedCurrencyValue(model.Param.Shop.MoneyUnit, ConvertToCurrency, value, new CompanyShop.Services.Service(Guid.Empty, "en"));
