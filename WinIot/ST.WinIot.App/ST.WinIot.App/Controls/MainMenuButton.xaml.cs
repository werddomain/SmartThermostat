...
{
    public sealed partial class MainMenuButton : Button
    {
        ...
        public static readonly DependencyProperty ButtonTextProperty =
            DependencyProperty.Register("ButtonText", typeof(string), typeof(MainMenuButton), new PropertyMetadata(null, OnButtonTextChanged));

        private async static void OnButtonTextChanged(DependencyObject dp, DependencyPropertyChangedEventArgs arg)
        {
            var obj = dp as MainMenuButton;
        ...
        public static readonly DependencyProperty ButtonIconProperty =
            DependencyProperty.Register("ButtonIcon", typeof(FontAwesomeIcon), typeof(MainMenuButton), new PropertyMetadata(FontAwesomeIcon.None, OnButtonIconChanged));
